			...
			<?php if(is_array($newlist)): foreach($newlist as $key=>$vo): ?><tr class="text-c va-m check-tr">
				    ...
				    <th class="td-status">
						<?php switch($vo['status']): case "0": ?><a  style="text-decoration:none"  href="<?php echo U('Local/local_view',array('id'=>$vo['id']));?>"  title='文章预览审核'>审核并查看详情</a><?php break;?>
							...
							<?php case "2": ?><a  style="text-decoration:none"  href="<?php echo U('Local/local_view',array('id'=>$vo['id']));?>"  title='审核未通过'><span class="label label-danger radius">审核未通过</span></a>
								<a  style="text-decoration:none" onclick="replay_msg('回复消息','/index.php/Admin/Local/replay/id/<?php echo ($vo["id"]); ?>',500,380)" href="javascript:;" title='审核未通过'><span class="label label-danger radius">回复消息</span></a><?php break;?>
						...
						<!--<?php if($vo[status]==0 ): ?><a  style="text-decoration:none"  href="<?php echo U('Local/local_view',array('id'=>$vo['id']));?>"  title='文章预览审核'>审核并查看详情</a>
							...
							<?php if($vo[status]==1): ?><a  style="text-decoration:none"  href="<?php echo U('Local/local_view',array('id'=>$vo['id']));?>"  title='已经审核通过'><span class="label label-success radius">审核通过</span></a>
								...
								<?php if($vo[status]==2 ): ?><a  style="text-decoration:none"  href="<?php echo U('Local/local_view',array('id'=>$vo['id']));?>"  title='审核未通过'><span class="label label-danger radius">审核未通过</span></a>
									<a  style="text-decoration:none" onclick="replay_msg('回复消息','/index.php/Admin/Local/replay/id/<?php echo ($vo["id"]); ?>',500,380)" href="javascript:;" title='审核未通过'><span class="label label-danger radius">回复消息</span></a>
									<?php else: ?>
				   ...
				   <td><?php echo ($vo["verifier"]); ?></td>
					...
					<td class="f-14 td-manage">
						...
						onClick="local_del(this,'/index.php/Admin/Local/local_del','<?php echo ($vo["id"]); ?>')"title="删除">
