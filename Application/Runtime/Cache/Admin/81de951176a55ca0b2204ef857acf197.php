...
<article class="page-container">
	...
	<?php if($cate_id): ?><!--<?php echo($cate_id);?>-->
		<!--获取到值-->
		<?php foreach ($cate_id as $k1 => $v1): if($k1 == 0) $opt = '[+]'; else $opt = '[-]'; ?>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-4"> <span class="select-box">
				...
				<select name="cate_id[]"  class="select" >
					...
					<?php foreach ($cateInfo as $k => $v): if($v['cate_id'] == $v1['cate_id']) $select='selected="selected"'; else $select = ''; ?>
			                    <option <?php echo ($select); ?> value="<?php echo ($v["cate_id"]); ?>"><?php echo ($v["cate_name"]); ?></option>
					<?php endforeach; ?>
				</select>
				</span>
			</div>
		...
		<!--<div class="row cl">-->
			...
			<!--<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">-->
				<!--<select class="select" name="cate_id">-->
				  <!--<?php if(is_array($cateInfo)): foreach($cateInfo as $key=>$vo): ?>-->
					<!--<?php if($vo['cate_id'] == $newsinfo['cate_id']): ?>-->
						<!--<option value="<?php echo ($vo["cate_id"]); ?>" selected>├<?php echo ($vo["cate_name"]); ?></option>-->
						<!--<?php else: ?>-->
