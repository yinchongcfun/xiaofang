...
<div class="page-container">
	<form action="/news/index.php/Admin/Local/replay/id/170" method="post" class="form form-horizontal" id="form-user-add">
		<p class="text-c"><span class="c-red">*</span>审核未通过原因：</p>
		<div class="row cl">
