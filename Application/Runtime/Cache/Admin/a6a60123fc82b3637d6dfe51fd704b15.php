...
<article class="page-container">
	<form class="form  form-horizontal" method="post"enctype="multipart/form-data" action="<?php echo U('local/localEditSave');?>" id="form-article-add">
	...
	<!--	<div class="row cl">
		...
		<!--<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box">
					&lt;!&ndash;<label for="rataion-1"><input type="radio" name="is_rataion" id="rataion-1" checked  value="0" >否</label>&ndash;&gt;
				...
				<div class="check-box">
					&lt;!&ndash;<label for="rataion-2"><input type="radio" name="is_rataion" id="rataion-2"   value="1">是</label>&ndash;&gt;
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<a  onclick="javascript:history.back()" class="btn btn-secondary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 返回</a>
			</div>
		</div>
	</form>
</article>
...
//选择标题颜色
		...
		var uploader = WebUploader.create({
			auto: true,
			swf: '/news/Public/Admin/lib/webuploader/0.1.5/Uploader.swf',
